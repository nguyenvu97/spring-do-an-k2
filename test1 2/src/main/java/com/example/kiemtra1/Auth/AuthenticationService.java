...
public class AuthenticationService {
    ...
    public AuthenticationResponse register(RegisterRequest request) {
        ...
        logger.info("Account create wallet  success" + user.getUsername());
    ...
    public AuthenticationResponse authenticate(AuthenticationRequest request) {
        ...
        var user = memberAccountRepo.findByUsername(request.getUsername())
                .orElseThrow();
        var jwtToken = jwtService.generateToken(user);
        var refreshToken = jwtService.generateRefreshToken(user);// here
        logger.info("Username Login :" + request.getUsername() +"&&"+ "time account login" + LocalTime.now());
