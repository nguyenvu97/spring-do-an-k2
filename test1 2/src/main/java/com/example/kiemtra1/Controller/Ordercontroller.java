...
public class Ordercontroller {
        //    http://localhost:8080/order/update/story{id}
    @Autowired
    ...
    @GetMapping("/story")
    public ResponseEntity<?> getAllOrdersForMember(@RequestParam String token) {
        List<Order> orders = orderSevice.getall(token);
