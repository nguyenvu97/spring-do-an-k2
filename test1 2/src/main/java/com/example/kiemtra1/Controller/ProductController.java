...
//    http://localhost:8080/product/top4Product{category} save
    @Autowired
    ...
    @PostMapping("/searchProducts") // findby productname use search
    ...
    @GetMapping("/category/{category}") // findby category
